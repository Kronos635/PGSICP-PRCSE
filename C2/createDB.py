...
def createTables(con):
    ...
    # "cascades" exists to maintain relashionships integrity in case of resrouces updates or deletion
    #
    # FIELDS:
    #   r_name - Role name (PRIMARY KEY)
    #   r_resource - Resource over which the role is to be applied
    #   r_permissions - Permissions to be grated by this role. It should be one of 2 values:
    ...
    # "cascades" exists to maintain relashionships integrity in case of updates or deletion on both "users" or "roles" tables
    #
    # FIELDS:
